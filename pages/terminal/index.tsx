    ...
    <div className='
      ...
      '>
        ...
        <span className='text-gray-500 mt-2 font-bold'>Use the
          <span
            className='text-gray-700 text-transparent bg-clip-text bg-gradient-to-r from-amber-300 via-fuchsia-400 to-violet-400'> Terminal </span>
      ...
      <div className='
        ...
        {/*linkedin*/}
        <a href='https://www.linkedin.com/in/mohammad-omar-taha/' target='_blank' rel='noreferrer' className='z-10 hover:text-blue-700'>
        ...
        {/*github*/}
        <a href='https://github.com/MohammadOTaha/portfolio' target='_blank' rel='noreferrer' className='z-10 hover:text-gray-500'>
